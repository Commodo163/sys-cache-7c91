...
TVBOX_M3U_URL="https://cdn.jsdelivr.net/gh/Commodo163/sys-cache-7c91@main/data/tvbox_auto_final_test.m3u?v=$CATALOG_VERSION"
CATALOG_JSON_URL="https://cdn.jsdelivr.net/gh/Commodo163/sys-cache-7c91@main/data/catalog.json?v=$CATALOG_VERSION"
...
cat > "$DATA/app_config.json" <<EOF
{
  ...
  "update": {
    "url": "https://raw.githubusercontent.com/Commodo163/sys-cache-7c91/main/data/apk/TVbox_2.2.1.apk",
